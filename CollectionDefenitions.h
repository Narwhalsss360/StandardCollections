...
#define ForEachIterator(type, name) void name(index_t index, type& value)
#define ConstForEachIterator(type, name) void name(index_t index, const type& value)
#define ForEachIteratorPointer(type, name) void(*name)(index_t, type&)
#define ConstForEachIteratorPointer(type, name) void(*name)(index_t, const type&)
