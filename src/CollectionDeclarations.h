...
public:
	...
	Array(const Array<CollectableType>& other);
...
public:
	...
	inline DynamicArray(const Collection<CollectableType>& other);

	inline DynamicArray(const DynamicArray<CollectableType>& other);
